...
struct ContentView: View {
    ...
    private var brandWordmark: some View {
        let titleLead = colorScheme == .dark ? Color.white.opacity(0.95) : Color(red: 0.42, green: 0.31, blue: 0.80)
        let titleTrail = AddemTheme.purpleTint
        let plateTop = colorScheme == .dark ? Color.white.opacity(0.26) : AddemTheme.purpleTint.opacity(0.34)
        let plateBottom = colorScheme == .dark ? Color.black.opacity(0.08) : Color.white.opacity(0.20)
        let border = colorScheme == .dark ? Color.white.opacity(0.56) : Color.white.opacity(0.70)
